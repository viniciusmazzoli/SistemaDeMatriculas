...
public class SistemaMatriculasCLI {
    private SistemaDeMatriculas sistema;
    private Universidade universidade;
    private Scanner teclado;

    public SistemaMatriculasCLI() {
        this.sistema = new SistemaDeMatriculas();
        this.universidade = new Universidade("Universidade Exemplo");
    ...
    private void configurarDadosIniciais() {
        ...
        universidade.adicionarCurso(engenhariaSoftware);
        ...
        Date umaSemanaAtras = new Date(hoje.getTime() - (1000 * 60 * 60 * 24 * 7));
        PeriodoMatricula periodoAtual = new PeriodoMatricula(umaSemanaAtras, amanha);
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    visualizarMinhasDisciplinas(aluno);
                    break;
                case 0:
    ...
    private void matricularEmDisciplina(Aluno aluno) {
        if (!isPeriodoMatriculaAtivo()) {
    ...
    private void visualizarMinhasDisciplinas(Aluno aluno) {
        System.out.println("\n--- Minhas Disciplinas ---");
    ...
    private void visualizarAlunosPorDisciplina(Professor professor) {
    ...
    private void visualizarCursosEDisciplinas() {
    ...
    private boolean isPeriodoMatriculaAtivo() {
    ...
    private int getIntInput() {
        while (!teclado.hasNextInt()) {
            ...
            teclado.next(); // Consome a entrada inválida
            System.out.print("Escolha uma opção: ");
        }
